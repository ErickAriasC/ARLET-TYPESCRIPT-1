...
let tipoServicio: number =1
let showServicio:string ="";
...
let domicilio: number=2;
let showDomicilio:string="";
...
//En lavados
//lavado en seco
function calcularCostoSeco():string {
    costo=numeroPrendas*2000;
    return "TIPO LAVADO:Seco \nVALOR FINAL:"+costo;
}
// lavado normal
function calcularCostoNormal():string {
    costo=numeroPrendas*1500;
    return "TIPO LAVADO:Normal \nVALOR FINAL:"+costo;
}

//En planchado
function calcularCostoPlanchado():string {
...
let tipoLavado: number =0;
let showTipoLavado:string="";
